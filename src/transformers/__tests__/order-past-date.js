...
// Request: order {"pretty":true,"pids":["870970-basis:28126727"],"expires":"2014-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}
'use strict';
...
describe('Automated test of the order endpoint', () => {
  it('expected response. ID:0yu9u1, for {"pretty":true,"pids":["870970-basis:28126727"],"expires":"2014-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}', (done) => {
    ...
    provider.execute('order', {"pretty":true,"pids":["870970-basis:28126727"],"expires":"2014-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}, context)
      .then(result => {
        assert.deepEqual(result,
            {"statusCode":400,"error":"The expire argument must be a future date"});
        done();
      })
      .catch(result => {
        fail({throw: result}, {"statusCode":400,"error":"The expire argument must be a future date"});
        done();
      });
  });
});
