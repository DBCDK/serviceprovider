...
describe('Automated test of the order endpoint', () => {
  it('expected response. ID:y252ty, for {"pids":["870970-basis:28126727"],"expires":"2014-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}', (done) => {
    ...
    provider.execute('order', {"pids":["870970-basis:28126727"],"expires":"2014-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}, context)
      .then(result => {
