...
describe('Automated test of the suggest endpoint', () => {
  it('expected response. ID:mh3y6t, for {"q":"herlev","type":"library","limit":3,"pretty":true}', (done) => {
    ...
    provider.execute('suggest', {"q":"herlev","type":"library","limit":3,"pretty":true}, context)
      .then(result => {
