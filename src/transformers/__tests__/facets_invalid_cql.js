...
describe('Automated test: __facets_invalid_cql', () => {
  it('expected response. ID:x6ycu6, for {"q":"invalid cql"}', done => {
    context.mockData = mockData;
    provider
      .execute('search', {q: 'invalid cql'}, context)
      .then(result => {
        assert.deepEqual(result, {
          statusCode: 500,
          error: '10: Query syntax error at pos 11'
        });
        done();
      })
      .catch(result => {
