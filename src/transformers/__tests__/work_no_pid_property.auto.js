// AUTOTEST GENERATOR: {"endpoint":"work","params":{"fields":["title","dcTitle","coverUrlFull","collection"]}}
//
//
// AUTOMATED UNIT TEST
// DO NOT EDIT
...
//
const endpoint = 'work';
const params = {fields: ['title', 'dcTitle', 'coverUrlFull', 'collection']};
...
describe('Automated test: work_no_pid_property.auto', () => {
  it('has same result as recorded (in work_no_pid_property.auto)', done => {
    assert(
