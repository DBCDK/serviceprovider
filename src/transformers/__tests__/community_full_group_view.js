    ...
    provider
      .execute(
        'getEntity',
        {
          ...
          counts: ['posts', 'likes', 'flags', 'follows'],
          selector: {type: 'group', id: '1'},
          _meta: {
            type: 'group',
            elvisType: 'entity',
            schemaMap: {
