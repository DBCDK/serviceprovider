...
describe('Automated test of the facets endpoint', () => {
  it('expected response. ID:gek6hm, for {"q":"aQueryMatchingNothing"}', (done) => {
    ...
    provider.execute('facets', {"q":"aQueryMatchingNothing"}, context)
      .then(result => {
