...
let mockData = {
  '["openuserstatus","<soapenv:Envelope xmlns:soapenv=\\"http://schemas.xmlsoap.org/soap/envelope/\\" xmlns:open=\\"http://oss.dbc.dk/ns/openuserstatus\\">\\n   <soapenv:Header/>\\n   <soapenv:Body>\\n      <open:renewLoanRequest>\\n         <open:agencyId>100451</open:agencyId>\\n         <open:authentication>\\n            <open:groupIdAut>XXXXX</open:groupIdAut>\\n            <open:passwordAut>XXXXX</open:passwordAut>\\n            <open:userIdAut>XXXXX</open:userIdAut>\\n         </open:authentication>\\n         <open:loanId>NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw=</open:loanId>\\n         <open:outputType>json</open:outputType>\\n         <open:userId>XXXXX</open:userId>\\n         <open:userPincode>XXXXX</open:userPincode>\\n      </open:renewLoanRequest>\\n   </soapenv:Body>\\n</soapenv:Envelope>"]':
    '{"renewLoanResponse":{"renewLoanStatus":[{"loanId":{"$":"NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw=","@":"ous"},"dateDue":{"$":"2017-01-01T00:00:00+01:00","@":"ous"},"@":"ous"}],"@":"ous"},"@namespaces":{"ous":"http:\\/\\/oss.dbc.dk\\/ns\\/openuserstatus"}}'
};
    ...
    provider
      ...
      .then(result => {
        assert.deepEqual(result, {
          ...
          data: {
            loanId: 'NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw=',
            returnDate: '2017-01-01T00:00:00+01:00'
          }
        });
        done();
      })
      .catch(result => {
        fail(
          {throw: result},
          {
            ...
            data: {
              loanId:
                'NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw=',
              returnDate: '2017-01-01T00:00:00+01:00'
            }
          }
        );
