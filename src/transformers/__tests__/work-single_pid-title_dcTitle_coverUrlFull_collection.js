...
describe('Automated test: work-single_pid-title_dcTitle_coverUrlFull_collection', () => {
  it('has same result as recorded (in work-single_pid-title_dcTitle_coverUrlFull_collection)', done => {
    assert(
