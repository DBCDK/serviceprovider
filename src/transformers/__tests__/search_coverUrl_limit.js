...
const mockData = {
  ...
  '["moreinfo",{"qs":{"action":"moreInfo","authenticationUser":"XXXXX","authenticationGroup":"XXXXX","authenticationPassword":"XXXXX","pidList":"775100-katalog:29602352","outputType":"json"}}]':
          ...
          data: [
            {
              ...
              acIdentifier: ['29602352|870970'],
              identifierISBN: ['9788771220353'],
              acSource: ['Bibliotekskatalog'],
              source: ['Warrior cats'],
              dcTitle: ['Krigerkattene'],
              dcTitleFull: ['Krigerkattene. Bind 6, Den mørkeste time'],
              ...
              version: ['1. udgave, 1. oplag (2012)'],
              publisher: ['Sohn'],
              contributorTrl: ['Jens Christiansen'],
              date: ['2012'],
              typeBibDKType: ['Bog'],
              extent: ['262 sider', '6 bind'],
              languageISO6392: ['dan'],
              dcLanguage: ['Dansk'],
              accessType: ['physical'],
              creator: ['Erin Hunter'],
