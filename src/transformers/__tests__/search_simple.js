    ...
    provider
      ...
      .then(result => {
        assert.deepEqual(result, {
          ...
          data: [
            {
              collection: ['870971-tsart:72819675'],
              collectionDetails: [
                {
                  accessType: ['physical'],
            ...
            {
              collection: ['870971-avis:73336317'],
              collectionDetails: [
                {
                  accessType: ['physical'],
            ...
            {
              collection: ['870971-tsart:72922190'],
              collectionDetails: [
                {
                  accessType: ['physical'],
            ...
            {
              collection: ['870971-avis:73528070'],
              collectionDetails: [
                {
                  accessType: ['physical'],
            ...
            {
              collection: ['870971-tsart:73150272'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Anna Panum'],
