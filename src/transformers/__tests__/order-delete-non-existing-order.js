...
// Request: order {"orderId":"non-existing","delete":true}
'use strict';
...
describe('Automated test of the order endpoint', () => {
  it('expected response. ID:okdu2y, for {"orderId":"non-existing","delete":true}', (done) => {
    ...
    provider.execute('order', {"orderId":"non-existing","delete":true}, context)
      .then(result => {
