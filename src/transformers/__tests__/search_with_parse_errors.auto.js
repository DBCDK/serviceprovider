...
const expected = {
  ...
  data: [
    ...
    },
    {
      ...
      alternative: ['Fisk & skaldyr', 'Hurtig i køkkenet - fisk og skaldyr'],
    ...
    },
    {
      ...
      dcTitleFull: ['Sårinfektioner hos fisk : forekomst, årsag og betydning'],
      ...
      partOf: ['Fisk og hav, 1994 = Skrifter... nr. 45 (1994)'],
      title: ['Sårinfektioner hos fisk'],
      titleFull: ['Sårinfektioner hos fisk : forekomst, årsag og betydning'],
      type: ['Tidsskriftsartikel'],
      workType: ['article']
    },
    {
    ...
    },
    {
      ...
      collectionDetails: [
        {
          ...
          titleFull: ['God og dårlig frossen fisk : hvorfor er der forskel?'],
          type: ['Tidsskriftsartikel'],
          workType: ['article']
        }
      ],
      ...
      dcTitleFull: ['God og dårlig frossen fisk : hvorfor er der forskel?'],
    ...
    },
    {
      ...
      dcTitleFull: ['Walt Disney præsenterer Hiawatha og den store fisk'],
...
describe('Automated test: search-with-parse-errors', () => {
  it('has same result as recorded (in search-with-parse-errors)', done => {
    assert(
