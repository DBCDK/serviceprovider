...
describe('Automated test: search_with_parse_errors.auto', () => {
  it('has same result as recorded (in search_with_parse_errors.auto)', done => {
    assert(
