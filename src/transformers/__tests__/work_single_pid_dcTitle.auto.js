...
describe('Automated test: work_single_pid_dcTitle.auto', () => {
  it('has same result as recorded (in work_single_pid_dcTitle.auto)', done => {
    assert(
