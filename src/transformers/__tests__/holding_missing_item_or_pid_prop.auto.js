// AUTOTEST GENERATOR: {"endpoint":"holding","params":{"pretty":true,"agency":"761500"}}
//
//
// AUTOMATED UNIT TEST
// DO NOT EDIT
...
const params = {"pretty":true,"agency":"761500"};

const expected = {"statusCode":400,"error":"Request must either contain the `pids` or `item_id` prop"};
...
describe('Automated test: holding_missing_item_or_pid_prop.auto', () => {
  it('has same result as recorded (in holding_missing_item_or_pid_prop.auto)', () => {
