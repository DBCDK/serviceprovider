      ...
      .then(result => {
        assert.deepEqual(result, {
          ...
          data: [
            ...
            {
              collection: ['775100-katalog:26111129'],
              collectionDetails: [],
              acIdentifier: ['26111129|870970'],
              identifierISBN: ['87-02-02636-8'],
              acSource: ['Bibliotekskatalog'],
              dcTitle: ['Fisk'],
              dcTitleFull: ['Fisk'],
              titleSeries: ['De små fagbøger'],
              creatorAut: ['Anders Uldal'],
              creatorSort: ['Uldal, Anders'],
              subjectDK5: ['58.6'],
              subjectDK5Text: ['Fisk'],
              subjectDBCF: ['fisk'],
              subjectDBCN: ['for 10 år', 'for 8 år', 'for 9 år'],
              description: [
              ...
              audienceAge: ['fra 8 år'],
              audience: ['børnematerialer'],
              version: ['1. udgave, 1. oplag (2006)'],
              publisher: ['Gyldendal'],
              date: ['2006'],
              typeBibDKType: ['Bog'],
              format: ['illustreret i farver'],
            ...
            {
              collection: ['870971-tsart:80309988'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Steen Ulnits'],
                  pid: ['870971-tsart:80309988'],
                  language: ['Dansk'],
                  partOf: ['Fisk & fri, 1991, nr. 7'],
                  title: ['Stallingens menukort'],
                  titleFull: ['Stallingens menukort'],
                  type: ['Tidsskriftsartikel'],
                  workType: ['article']
                }
              ],
              acIdentifier: ['80309988|870971'],
              acSource: ['Tidsskriftsartikler'],
              dcTitle: ['Stallingens menukort'],
              dcTitleFull: ['Stallingens menukort'],
              dcCreator: ['Steen Ulnits'],
              creatorSort: ['Ulnits, Steen'],
              subjectDK5: ['58.6'],
              subjectDK5Text: ['Fisk'],
              subject: [
                'Pisces',
            ...
            {
              collection: ['870971-tsart:72546555'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Lars Nielsen'],
                  pid: ['870971-tsart:72546555'],
                  language: ['Dansk'],
                  partOf: ['Fisk & fri, 1987, nr. 7'],
                  title: ['Masser af fisk i Mossø'],
                  titleFull: ['Masser af fisk i Mossø'],
                  type: ['Tidsskriftsartikel'],
                  workType: ['article']
                }
              ],
              acIdentifier: ['72546555|870971'],
              acSource: ['Tidsskriftsartikler'],
              dcTitle: ['Masser af fisk i Mossø'],
              dcTitleFull: ['Masser af fisk i Mossø'],
              dcCreator: ['Lars Nielsen'],
              creatorSort: ['Nielsen, Lars'],
              subjectDK5: ['58.6'],
              subjectDK5Text: ['Fisk'],
              ...
              abstract: ['Kortlægning af fiskebestanden'],
              audience: ['voksenmaterialer'],
              date: ['1987'],
              typeBibDKType: ['Tidsskriftsartikel'],
              extent: ['S. 20-22'],
            ...
            {
              collection: ['870971-tsart:72546563'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Bent Vogel'],
                  pid: ['870971-tsart:72546563'],
                  language: ['Dansk'],
                  partOf: ['Origo, Årg. 5, nr. 2 (1987)'],
                  title: ['Elektriske fisk: skabelse eller evolution?'],
                  titleFull: ['Elektriske fisk: skabelse eller evolution?'],
                  type: ['Tidsskriftsartikel'],
                  workType: ['article']
                }
              ],
              acIdentifier: ['72546563|870971'],
              acSource: ['Tidsskriftsartikler'],
              dcTitle: ['Elektriske fisk: skabelse eller evolution?'],
              dcTitleFull: ['Elektriske fisk: skabelse eller evolution?'],
              dcCreator: ['Bent Vogel'],
              creatorSort: ['Vogel, Bent'],
              subjectDK5: ['58.6'],
              subjectDK5Text: ['Fisk'],
              subject: [
                'Pisces',
              ...
              languageISO6392: ['dan'],
              dcLanguage: ['Dansk'],
              isPartOf: ['Origo, Årg. 5, nr. 2 (1987)'],
              isPartOfISSN: ['0109-6168'],
              accessType: ['physical'],
              creator: ['Bent Vogel'],
              pid: ['870971-tsart:72546563'],
              language: ['Dansk'],
            ...
            {
              collection: ['870971-tsart:73401518'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Alf Stalsberg'],
                  pid: ['870971-tsart:73401518'],
                  language: ['Dansk'],
                  partOf: ['Akvariebladet, Årg. 21, nr. 9 (1989)'],
                  title: ['Nye navne på kendte fisk'],
                  titleFull: ['Nye navne på kendte fisk'],
                  type: ['Tidsskriftsartikel'],
                  workType: ['article']
                }
              ],
              acIdentifier: ['73401518|870971'],
              acSource: ['Tidsskriftsartikler'],
              dcTitle: ['Nye navne på kendte fisk'],
              dcTitleFull: ['Nye navne på kendte fisk'],
              dcCreator: ['Alf Stalsberg'],
              creatorSort: ['Stalsberg, Alf'],
              subjectDK5: ['58.6'],
              subjectDK5Text: ['Fisk'],
              subject: [
                'Pisces',
              ...
              date: ['1989'],
              typeBibDKType: ['Tidsskriftsartikel'],
              extent: ['S. 313-315, 319-322'],
              languageISO6392: ['dan'],
              dcLanguage: ['Dansk'],
              isPartOf: ['Akvariebladet, Årg. 21, nr. 9 (1989)'],
            ...
            {
              collection: ['870971-tsart:70921685'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Knud Larsen'],
                  pid: ['870971-tsart:70921685'],
                  language: ['Dansk'],
                  partOf: ['Fisk & fri, 1982, nr. 2'],
                  title: ['Aflivning og rensning af fisk'],
                  titleFull: ['Aflivning og rensning af fisk'],
                  type: ['Tidsskriftsartikel'],
                  workType: ['article']
                }
              ],
              acIdentifier: ['70921685|870971'],
              acSource: ['Tidsskriftsartikler'],
              dcTitle: ['Aflivning og rensning af fisk'],
              dcTitleFull: ['Aflivning og rensning af fisk'],
              dcCreator: ['Knud Larsen'],
              creatorSort: ['Larsen, Knud'],
              subjectDK5: ['79.97'],
              subjectDK5Text: ['Sportsfiskeri i alm.'],
              subject: [
                'aflivning fisk',
                'fiskeri',
                'lystfiskeri',
            ...
            {
              collection: ['870971-avis:87389677'],
              collectionDetails: [
                {
                  accessType: ['physical'],
                  creator: ['Jette Warrer Knudsen'],
                  pid: ['870971-avis:87389677'],
                  language: ['Dansk'],
                  partOf: ['Børsen, 2003-08-11'],
                  title: ['Frosne fisk kan slå friske på kvalitet'],
                  titleFull: ['Frosne fisk kan slå friske på kvalitet'],
                  type: ['Avisartikel'],
                  workType: ['article']
                }
              ],
              acIdentifier: ['87389677|870971'],
              acSource: ['Avisartikler'],
              dcTitle: ['Frosne fisk kan slå friske på kvalitet'],
              dcTitleFull: ['Frosne fisk kan slå friske på kvalitet'],
              dcCreator: ['Jette Warrer Knudsen'],
              creatorSort: ['Warrer Knudsen, Jette'],
              subjectDK5: ['66.85'],
              subjectDK5Text: ['Slagteri. Kød- og fiskeindustri'],
              subjectDBCF: ['dybfrosne fisk', 'ernæring', 'fisk'],
              abstract: [
              ...
              extent: ['Fødevarer, s. 2'],
              languageISO6392: ['dan'],
              dcLanguage: ['Dansk'],
              isPartOf: ['Børsen, 2003-08-11'],
              isPartOfISSN: ['0105-0729'],
              accessType: ['physical'],
              creator: ['Jette Warrer Knudsen'],
              pid: ['870971-avis:87389677'],
              language: ['Dansk'],
