...
const expected = {"statusCode":200,"data":{"id":"0EvLbHAPkNavGf68am7XTMxMZqg0mOKb","name":"Anders Villadsen","address":"Palle Juul-Jensens Boulevard 115","postalCode":"8200","loans":[{"loanId":"120200553","dueDate":"2020-01-24T00:00:00+01:00","title":"One Direction: den officielle årbog 2014","creator":"Delmege, Sarah","materialId":"9788771312492","titleId":"51098838"}],"orders":[],"debt":[{"amount":"224","currency":"DKK","date":"1970-01-01T00:00:00+01:00","title":""},{"amount":"50","currency":"DKK","date":"1970-01-01T00:00:00+01:00","title":""}],"ddbcmsapi":"https://cmscontent.dbc.dk/","agency":"790900"}};
...
describe('Automated test: user_userinfo_userdata_userloan_userorder_userfiscal_spec_set.auto', () => {
  it('has same result as recorded (in user_userinfo_userdata_userloan_userorder_userfiscal_spec_set.auto)', () => {
    assert(Date.now() < +new Date('2020-07-27'), 'Please recreate the automatically generated unit tests, such that the mock data does not come out of sync with the actual services. See README.md for details.');
