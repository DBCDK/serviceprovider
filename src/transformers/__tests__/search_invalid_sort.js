...
describe('Automated test: __search_invalid_sort', () => {
  it('expected response. ID:vfvqs9, for {"q":"harry AND potter","fields":["identifier","title","collection","subjectDBCF","hasAdaptation"],"sort":"invalid_sort"}', (done) => {
