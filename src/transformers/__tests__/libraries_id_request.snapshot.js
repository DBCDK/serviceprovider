...
// Request: libraries {"agencyIds":["726500"],"branchIds":["726500"]}
...
describe('Automated test: libraries_id_request', () => {
  it('expected response. ID:x2vjb7, for {"agencyIds":["726500"],"branchIds":["726500"]}', done => {
    context.mockData = mockData;
    provider
      .execute(
        'libraries',
        {agencyIds: ['726500'], branchIds: ['726500']},
        context
      )
      .then(result => {
          ...
          data: [
            {
              ...
              lookupUrl:
                'https://www.roskildebib.dk/web/arena/results?p_p_id=crDetailWicket_WAR_arenaportlets&p_p_lifecycle=1&p_p_state=normal&p_p_mode=view&agency_name=ADK726500&search_item_id=',
