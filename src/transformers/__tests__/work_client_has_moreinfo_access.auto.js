...
const expected = {
  ...
  data: [
    {
      coverUrl117: [
        'https://XXXXX.addi.dk/2.11/more_info_get.php?lokalid=47051649&attachment_type=forside_117&bibliotek=870970&source_id=150020&key=7fdaa1dfea2e14c5bcb8'
      ],
      coverUrl207: [
        'https://XXXXX.addi.dk/2.11/more_info_get.php?lokalid=47051649&attachment_type=forside_207&bibliotek=870970&source_id=150020&key=22759b0648c93a02f2a0'
      ],
      coverUrl42: [
        'https://XXXXX.addi.dk/2.11/more_info_get.php?lokalid=47051649&attachment_type=forside_42&bibliotek=870970&source_id=150020&key=9a5e0fd48edb0ebf1481'
      ],
      coverUrl500: [
        'https://XXXXX.addi.dk/2.11/more_info_get.php?lokalid=47051649&attachment_type=forside_500&bibliotek=870970&source_id=150020&key=932d2536633be94ca0ca'
      ],
      coverUrlThumbnail: [
        'https://XXXXX.addi.dk/2.11/more_info_get.php?lokalid=47051649&attachment_type=forside_lille&bibliotek=870970&source_id=150020&key=20f8083c8920d162e4a9'
      ],
      coverUrlFull: [
        'https://XXXXX.addi.dk/2.11/more_info_get.php?lokalid=47051649&attachment_type=forside_stor&bibliotek=870970&source_id=150020&key=2c67e3231589773d1204'
      ],
...
const context = {
  services: {
    ...
    XXXXX: 'https://XXXXX.addi.dk/2.11/',
...
const mockData = {
  '["XXXXX",{"qs":{"action":"moreInfo","authenticationUser":"XXXXX","authenticationGroup":"XXXXX","authenticationPassword":"XXXXX","pidList":"870970-basis:47051649","outputType":"json"}}]':
    '{"moreInfoResponse":{"requestStatus":{"statusEnum":{"$":"ok","@":"mi"},"errorText":{"$":"","@":"mi"},"@":"mi"},"identifierInformation":[{"identifierKnown":{"$":"true","@":"mi"},"identifier":{"pid":{"$":"870970-basis:47051649","@":"mi"},"@":"mi"},"coverImage":[{"$":"https:\\/\\/XXXXX.addi.dk\\/2.11\\/more_info_get.php?lokalid=47051649&attachment_type=forside_117&bibliotek=870970&source_id=150020&key=7fdaa1dfea2e14c5bcb8","@imageSize":{"$":"detail_117"},"@imageFormat":{"$":"jpeg"},"@":"mi"},{"$":"https:\\/\\/XXXXX.addi.dk\\/2.11\\/more_info_get.php?lokalid=47051649&attachment_type=forside_207&bibliotek=870970&source_id=150020&key=22759b0648c93a02f2a0","@imageSize":{"$":"detail_207"},"@imageFormat":{"$":"jpeg"},"@":"mi"},{"$":"https:\\/\\/XXXXX.addi.dk\\/2.11\\/more_info_get.php?lokalid=47051649&attachment_type=forside_42&bibliotek=870970&source_id=150020&key=9a5e0fd48edb0ebf1481","@imageSize":{"$":"detail_42"},"@imageFormat":{"$":"jpeg"},"@":"mi"},{"$":"https:\\/\\/XXXXX.addi.dk\\/2.11\\/more_info_get.php?lokalid=47051649&attachment_type=forside_500&bibliotek=870970&source_id=150020&key=932d2536633be94ca0ca","@imageSize":{"$":"detail_500"},"@imageFormat":{"$":"jpeg"},"@":"mi"},{"$":"https:\\/\\/XXXXX.addi.dk\\/2.11\\/more_info_get.php?lokalid=47051649&attachment_type=forside_lille&bibliotek=870970&source_id=150020&key=20f8083c8920d162e4a9","@imageSize":{"$":"thumbnail"},"@imageFormat":{"$":"jpeg"},"@":"mi"},{"$":"https:\\/\\/XXXXX.addi.dk\\/2.11\\/more_info_get.php?lokalid=47051649&attachment_type=forside_stor&bibliotek=870970&source_id=150020&key=2c67e3231589773d1204","@imageSize":{"$":"detail"},"@imageFormat":{"$":"jpeg"},"@":"mi"}],"@":"mi"}],"@":"mi"},"@namespaces":{"mi":"http:\\/\\/oss.dbc.dk\\/ns\\/XXXXX"}}',
...
describe('Automated test: work_client_has_XXXXX_access.auto', () => {
  it('has same result as recorded (in work_client_has_XXXXX_access.auto)', () => {
    assert(
      Date.now() < +new Date('2021-09-19'),
