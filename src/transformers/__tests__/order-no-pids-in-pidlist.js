...
// Request: order {"pids":[],"expires":"2016-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}
'use strict';
...
describe('Automated test of the order endpoint', () => {
  it('expected response. ID:pbhm3a, for {"pids":[],"expires":"2016-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}', (done) => {
    ...
    provider.execute('order', {"pids":[],"expires":"2016-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL"}, context)
      .then(result => {
        assert.deepEqual(result,
            {"statusCode":400,"error":"At least one pid must be provided to place order"});
        done();
      })
      .catch(result => {
        fail({throw: result}, {"statusCode":400,"error":"At least one pid must be provided to place order"});
        done();
      });
  });
});
