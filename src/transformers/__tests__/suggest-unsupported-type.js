...
// Request: suggest {"q":"herlev","type":"unsupported","limit":3}
'use strict';
...
describe('Automated test of the suggest endpoint', () => {
  it('expected response. ID:d0mcsy, for {"q":"herlev","type":"unsupported","limit":3}', (done) => {
    ...
    provider.execute('suggest', {"q":"herlev","type":"unsupported","limit":3}, context)
      .then(result => {
