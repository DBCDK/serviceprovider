...
const expected = {
  ...
  data: {
    access: [
      {term: 'begrænset adgang', frequency: 91},
      {term: 'ubegrænset adgang', frequency: 19}
    ],
    acSource: [
      {term: 'bibliotekskatalog', frequency: 673},
      {term: 'tidsskriftsartikler', frequency: 451}
    ],
    audience: [
      {term: 'fra 7 år', frequency: 25},
      {term: 'fra 5 år', frequency: 21}
    ],
    audienceCategory: [
      {term: 'for 7 år', frequency: 55},
      {term: 'for 8 år', frequency: 46}
    ],
    branch: [{term: 'hb', frequency: 90}, {term: 'ris', frequency: 46}],
    category: [
      {term: 'voksenmaterialer', frequency: 1050},
      {term: 'børnematerialer', frequency: 226}
    ],
    creator: [
      {term: 'robert hansen', frequency: 76},
      {term: 'hanne hastrup', frequency: 41}
    ],
    creatorFunction: [
      {term: 'robert hansen', frequency: 76},
      {term: 'hanne hastrup', frequency: 39}
    ],
    date: [{term: '2000', frequency: 49}, {term: '2015', frequency: 46}],
    dk5: [
      {term: '63.7', frequency: 522},
      {term: 'skønlitteratur', frequency: 159}
    ],
    extraTitles: [{term: 'ekstra titler', frequency: 2}],
    fictionSubject: [
      {term: 'mus', frequency: 44},
      {term: 'sjove bøger', frequency: 21}
    ],
    form: [
      {term: 'opskrifter', frequency: 87},
      {term: 'kogebøger', frequency: 80}
    ],
    gamePlatform: [{term: 'pc-spil', frequency: 1}],
    genre: [
      {term: 'sjove bøger', frequency: 19},
      {term: 'børnefilm', frequency: 18}
    ],
    genreCategory: [
      {term: 'nonfiktion', frequency: 944},
      {term: 'fiktion', frequency: 192}
    ],
    geographic: [
      {term: 'danmark', frequency: 82},
      {term: 'frankrig', frequency: 22}
    ],
    language: [
      {term: 'dansk', frequency: 954},
      {term: 'blandede sprog', frequency: 128}
    ],
    level: [
      {term: 'alment niveau', frequency: 105},
      {term: 'folkeskoleniveau', frequency: 12}
    ],
    let: [{term: '16', frequency: 8}, {term: '14', frequency: 4}],
    literaryForm: [
      {term: 'faglitteratur', frequency: 944},
      {term: 'skønlitteratur', frequency: 192}
    ],
    lix: [{term: '07', frequency: 7}, {term: '15', frequency: 4}],
    musicSubject: [
      {term: 'vokal', frequency: 59},
      {term: 'børnemusik', frequency: 25}
    ],
    nationality: [
      {term: 'amerikanske film', frequency: 6},
      {term: 'danske film', frequency: 5}
    ],
    nonFictionSubject: [
      {term: 'ost', frequency: 279},
      {term: 'mejeribrug', frequency: 71}
    ],
    partOf: [
      {term: 'mælkeritidende', frequency: 189},
      {term: 'nordeuropæisk mejeri-tidsskrift', frequency: 55}
    ],
    period: [
      {term: '1990-1999', frequency: 39},
      {term: '2000-2009', frequency: 38}
    ],
    primaryCreator: [
      {term: 'robert hansen', frequency: 76},
      {term: 'j. m. buch kristensen', frequency: 29}
    ],
    sheetMusic: [{term: 'alle partiturer', frequency: 10}],
    subject: [{term: 'ost', frequency: 541}, {term: 'danmark', frequency: 97}],
    titleSeries: [
      {term: 'mini zoom. mellem', frequency: 6},
      {term: 'dansk sang b-serien', frequency: 5}
    ],
    type: [
      {term: 'tidsskriftsartikel', frequency: 450},
      {term: 'bog', frequency: 395}
    ]
  }
};
...
describe('Automated test: facets_all', () => {
  it('has same result as recorded (in facets_all)', done => {
    assert(
