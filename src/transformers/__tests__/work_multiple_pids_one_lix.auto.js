// AUTOTEST GENERATOR: {"endpoint":"work","params":{"fields":["lix","dcTitle"],"pids":["870970-basis:50877523","870970-basis:51226828"]}}
//
//
// AUTOMATED UNIT TEST
// DO NOT EDIT
...
const mockData = {
  ...
  '["XXXXX",{"qs":{"pid":"870970-basis:51226828","action":"formatObject","outputFormat":"{\\"fields\\":{\\"lix\\":\\"{lix}\\"}}"}}]':
...
describe('Automated test: work_multiple_pids_one_lix.auto', () => {
  it('has same result as recorded (in work_multiple_pids_one_lix.auto)', () => {
    assert(
