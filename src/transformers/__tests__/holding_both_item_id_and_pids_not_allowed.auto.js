...
const params = {"pretty":true,"agency":"761500","item_id":"3439785456","pids":["somepids"]};

const expected = {"statusCode":400,"error":"Request is not allowed to contain both `pids` and `item_id` prop"};
