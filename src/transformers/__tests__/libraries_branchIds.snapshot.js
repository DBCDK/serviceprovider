// AUTOTEST GENERATOR: {"endpoint":"libraries","params":{"fields":["agencyID","branchId","orderParameters"],"branchIds":["717500","717501","717502"]}}
//
//
// AUTOMATED UNIT TEST
// DO NOT EDIT
...
const params = {
  fields: ['agencyID', 'branchId', 'orderParameters'],
  branchIds: ['717500', '717501', '717502']
};
...
const expected = {
  ...
  data: [
    ...
    },
    {
      ...
      temporarilyClosed: '1',
      temporarilyClosedReason: ['Temporary closed', 'Lukket pga Covid-19'],
      pickupAllowed: '0',
      dropOffBranch: '717500',
      dropOffName: 'Rødovre Kommunebiblioteker',
...
describe('Automated test: libraries_branchIds.snapshot', () => {
  it('has same result as recorded (in libraries_branchIds.snapshot)', () => {
    assert(
