...
const expected = {
  ...
  data: {
    ...
    subject: [
      {term: 'vokal', frequency: 1854},
      {term: 'usa', frequency: 1715},
      {term: 'instrumental', frequency: 831},
      {term: 'england', frequency: 830},
      {term: 'rock', frequency: 726},
      {term: 'jazz', frequency: 621},
      {term: 'krimi', frequency: 557},
      {term: '2000-2009', frequency: 554},
      {term: 'danmark', frequency: 554},
      {term: 'troldmænd', frequency: 513}
    ],
    language: [
      {term: 'engelsk', frequency: 6712},
      {term: 'dansk', frequency: 3901},
...
describe('Automated test: facets_simple', () => {
  it('has same result as recorded (in facets_simple)', done => {
    assert(
