...
describe('Automated test: facets_simple', () => {
  it('expected response. ID:8iuwzo, for {"q":"harry","pretty":true}', done => {
    ...
    provider
      .execute('facets', {q: 'harry', pretty: true}, context)
      .then(result => {
        assert.deepEqual(result, {
          ...
          data: {
            creator: [
              ...
              {term: 'jo nesbø', frequency: 61},
              {term: 'michael connelly', frequency: 44},
              {term: 'harry christophers', frequency: 37},
              {term: 'the sixteen', frequency: 34},
              {term: 'harry edison', frequency: 29},
              {term: 'georg friedrich händel', frequency: 27},
              {term: 'allan hilton andersen', frequency: 26},
              {term: 'bent otto hansen', frequency: 25},
              {term: 'harry nilsson', frequency: 23}
            ],
            subject: [
              {term: 'vokal', frequency: 469},
              {term: 'usa', frequency: 376},
              {term: 'rock', frequency: 203},
              {term: 'england', frequency: 202},
              {term: 'instrumental', frequency: 193},
              {term: '2000-2009', frequency: 152},
              {term: 'danmark', frequency: 152},
              {term: 'jazz', frequency: 134},
              {term: '1960-1969', frequency: 130},
              {term: 'krimi', frequency: 129}
            ],
            language: [
              {term: 'engelsk', frequency: 680},
              {term: 'dansk', frequency: 589},
              {term: 'blandede sprog', frequency: 189},
              {term: 'latin', frequency: 17},
              {term: 'tysk', frequency: 12},
              {term: 'italiensk', frequency: 10},
              {term: 'russisk', frequency: 8},
              {term: 'fransk', frequency: 7},
              {term: 'svensk', frequency: 7},
              {term: 'norsk', frequency: 6}
            ],
            date: [
              {term: '2012', frequency: 108},
              {term: '2013', frequency: 101},
              {term: '2009', frequency: 97},
              {term: '2015', frequency: 96},
              {term: '2011', frequency: 95},
              {term: '2007', frequency: 93},
              {term: '2014', frequency: 81},
              {term: '2006', frequency: 80},
              {term: '2005', frequency: 78},
              {term: '2004', frequency: 76}
            ],
            form: [
              {term: 'amerikanske film', frequency: 40},
              {term: 'soundtracks', frequency: 32},
              {term: 'computerspil', frequency: 30},
              {term: 'biografier', frequency: 27},
              {term: 'actionspil', frequency: 20},
              {term: 'adventurespil', frequency: 15},
              {term: 'engelske film', frequency: 13},
              {term: 'undervisningsmaterialer', frequency: 11},
              {term: 'erindringer', frequency: 8},
              {term: 'håndbøger', frequency: 8}
            ]
          }
        });
        done();
