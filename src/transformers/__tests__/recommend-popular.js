...
let mockData = {
  '["https://xptest.dbc.dk/ms/recommend-pop/v1",{"method":"POST","json":{"like":[],"dislike":[],"known":[],"discard":[],"maxresults":3,"filter":["rec.collectionIdentifier:150013-palle OR rec.collectionIdentifier:758000-katalog"]}}]': {
    result: [
      [
      ...
      [
        '870970-basis:28567057',
        {
          creator: 'Sara Blædel',
          val: 25139,
          title: 'Dødsenglen : krimi',
          pid: '870970-basis:28567057'
        }
      ]
    ],
    msecs: 274
...
describe('Automated test: recommend-popular', () => {
  it('expected response. ID:h0a3kh, for {"recommender":"popular","limit":3,"pretty":true}', done => {
    ...
    provider
      .execute(
        'recommend',
        {recommender: 'popular', limit: 3, pretty: true},
        context
      )
      .then(result => {
