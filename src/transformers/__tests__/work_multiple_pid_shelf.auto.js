// AUTOTEST GENERATOR: {"endpoint":"work","params":{"fields":["shelf","pid","dcTitle"],"pids":["870970-basis:51068696","870970-basis:26717159"]}}
//
//
// AUTOMATED UNIT TEST
// DO NOT EDIT
...
const params = {
  ...
  pids: ['870970-basis:51068696', '870970-basis:26717159']
};
...
const expected = {
  ...
  data: [
    {
      acIdentifier: ['51068696|870970'],
      identifierISBN: ['9788711357606'],
      acSource: ['Bibliotekskatalog'],
      source: ['Stoner'],
      dcTitle: ['Stoner'],
      dcTitleFull: ['Stoner'],
      creatorAut: ['John Williams (f. 1922)'],
      creatorSort: ['Williams, John (f. 1922)'],
      ...
      contributorTrl: ['Jens Christian Grøndahl'],
      date: ['2014'],
      typeBibDKType: ['Bog'],
      extent: ['302 sider'],
      languageISO6392: ['dan'],
      dcLanguage: ['Dansk'],
      spatialDBCS: ['Missouri', 'USA'],
      temporalDBCP: [
        '1910-1919',
        '1920-1929',
        '1930-1939',
      ...
      fedoraPid: ['870970-basis:51068696'],
      pid: ['870970-basis:51068696'],
      language: ['Dansk'],
      title: ['Stoner'],
      titleFull: ['Stoner'],
      type: ['Bog'],
...
const mockData = {
  ...
  '["XXXXX",{"qs":{"action":"formatObject","pid":"870970-basis:51068696","outputFormat":"{\\"fields\\":{\\"shelf\\":\\"{shelf}\\"}}"}}]':
    '<?xml version="1.0" encoding="UTF-8"?><SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:of="http://oss.dbc.dk/ns/openformat"><SOAP-ENV:Body><of:formatResponse><customDisplay><fields><shelf>skønlitteratur</shelf></fields></customDisplay></of:formatResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>\n',
  '["opensearch",{"qs":{"action":"getObject","identifier":["870970-basis:51068696","870970-basis:26717159"],"agency":"775100","profile":"opac","outputType":"json","objectFormat":["briefDisplay","dkabm"]}}]':
    '{"searchResponse":{"result":{"hitCount":{"$":"2"},"collectionCount":{"$":"2"},"more":{"$":"false"},"searchResult":[{"collection":{"resultPosition":{"$":"1"},"numberOfObjects":{"$":"1"},"object":[{"record":{"identifier":[{"$":"51068696|870970","@":"ac"},{"$":"9788711357606","@type":{"$":"dkdcplus:ISBN","@":"xsi"},"@":"dc"}],"source":[{"$":"Bibliotekskatalog","@":"ac"},{"$":"Stoner","@":"dc"}],"title":[{"$":"Stoner","@":"dc"},{"$":"Stoner","@type":{"$":"dkdcplus:full","@":"xsi"},"@":"dc"}],"creator":[{"$":"John Williams (f. 1922)","@type":{"$":"dkdcplus:aut","@":"xsi"},"@":"dc"},{"$":"Williams, John (f. 1922)","@type":{"$":"oss:sort","@":"xsi"},"@":"dc"}],"subject":[{"$":"Sk\\u00f8nlitteratur","@type":{"$":"dkdcplus:DK5-Text","@":"xsi"},"@":"dc"},{"$":"far-datter-forholdet","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"identitet","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"karriere","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"konflikter","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"litteratur","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"m\\u00e6nd","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"sk","@type":{"$":"dkdcplus:DK5","@":"xsi"},"@":"dc"},{"$":"universiteter","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"\\u00e6gteskab","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"}],"abstract":[{"$":"Husmandss\\u00f8nnen William Stoner fra Missouri, USA,  bliver i 1910 sendt p\\u00e5 landbrugsskole, men v\\u00e6lger litteraturens verden, bliver universitetsl\\u00e6rer og vender ikke senere tilbage til for\\u00e6ldrenes g\\u00e5rd","@":"dcterms"}],"audience":[{"$":"voksenmaterialer","@":"dcterms"}],"version":[{"$":"1. udgave, 1. oplag (2014)","@":"dkdcplus"}],"publisher":[{"$":"Lindhardt og Ringhof","@":"dc"}],"contributor":[{"$":"Jens Christian Gr\\u00f8ndahl","@type":{"$":"dkdcplus:trl","@":"xsi"},"@":"dc"}],"date":[{"$":"2014","@":"dc"}],"type":[{"$":"Bog","@type":{"$":"dkdcplus:BibDK-Type","@":"xsi"},"@":"dc"}],"extent":[{"$":"302 sider","@":"dcterms"}],"language":[{"$":"dan","@type":{"$":"dcterms:ISO639-2","@":"xsi"},"@":"dc"},{"$":"Dansk","@":"dc"}],"spatial":[{"$":"Missouri","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dcterms"},{"$":"USA","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dcterms"}],"temporal":[{"$":"1910-1919","@type":{"$":"dkdcplus:DBCP","@":"xsi"},"@":"dcterms"},{"$":"1920-1929","@type":{"$":"dkdcplus:DBCP","@":"xsi"},"@":"dcterms"},{"$":"1930-1939","@type":{"$":"dkdcplus:DBCP","@":"xsi"},"@":"dcterms"},{"$":"1940-1949","@type":{"$":"dkdcplus:DBCP","@":"xsi"},"@":"dcterms"},{"$":"1950-1959","@type":{"$":"dkdcplus:DBCP","@":"xsi"},"@":"dcterms"}],"@":"dkabm"},"identifier":{"$":"870970-basis:51068696"},"primaryObjectIdentifier":{"$":"870970-basis:51068696"},"recordStatus":{"$":"active"},"creationDate":{"$":"2016-07-09"},"formatsAvailable":{"format":[{"$":"dkabm"},{"$":"marcxchange"}]}}]},"formattedCollection":{"briefDisplay":{"manifestation":[{"accessType":{"$":"physical"},"creator":{"$":"John Williams (f. 1922)"},"fedoraPid":{"$":"870970-basis:51068696"},"identifier":{"$":"870970-basis:51068696"},"language":{"$":"Dansk"},"title":{"$":"Stoner"},"titleFull":{"$":"Stoner"},"type":{"$":"Bog"},"workType":{"$":"book"}}]}}},{"collection":{"resultPosition":{"$":"2"},"numberOfObjects":{"$":"1"},"object":[{"record":{"identifier":[{"$":"26717159|870970","@":"ac"},{"$":"9788702052688","@type":{"$":"dkdcplus:ISBN","@":"xsi"},"@":"dc"}],"source":[{"$":"Bibliotekskatalog","@":"ac"},{"$":"Tatt av kvinden","@":"dc"}],"title":[{"$":"Kvinden flytter ind","@":"dc"},{"$":"Kvinden flytter ind","@type":{"$":"dkdcplus:full","@":"xsi"},"@":"dc"}],"creator":[{"$":"Erlend Loe","@type":{"$":"dkdcplus:aut","@":"xsi"},"@":"dc"},{"$":"Loe, Erlend","@type":{"$":"oss:sort","@":"xsi"},"@":"dc"}],"subject":[{"$":"Sk\\u00f8nlitteratur","@type":{"$":"dkdcplus:DK5-Text","@":"xsi"},"@":"dc"},{"$":"humor","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"humor","@type":{"$":"dkdcplus:genre","@":"xsi"},"@":"dc"},{"$":"kvinder","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"m\\u00e6nd","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"parforhold","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dc"},{"$":"sk","@type":{"$":"dkdcplus:DK5","@":"xsi"},"@":"dc"}],"abstract":[{"$":"Den navnl\\u00f8se, flegmatiske unge mands forhold til Marianne, som uden varsel er flyttet ind hos ham. Han er den tavse type, hun den snakkesalige. Efter en tur til Europa, forlader hun ham gradvist til fordel for en anden, og f\\u00f8rst da bliver han for alvor forelsket i hende","@":"dcterms"}],"audience":[{"$":"voksenmaterialer","@":"dcterms"}],"version":[{"$":"1. oplag (2007)","@":"dkdcplus"}],"publisher":[{"$":"Gyldendal","@":"dc"}],"date":[{"$":"2007","@":"dc"}],"type":[{"$":"Bog","@type":{"$":"dkdcplus:BibDK-Type","@":"xsi"},"@":"dc"}],"extent":[{"$":"158 sider","@":"dcterms"}],"language":[{"$":"dan","@type":{"$":"dcterms:ISO639-2","@":"xsi"},"@":"dc"},{"$":"Dansk","@":"dc"}],"spatial":[{"$":"Norge","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dcterms"},{"$":"Oslo","@type":{"$":"dkdcplus:DBCS","@":"xsi"},"@":"dcterms"}],"@":"dkabm"},"identifier":{"$":"870970-basis:26717159"},"primaryObjectIdentifier":{"$":"870970-basis:26717159"},"recordStatus":{"$":"active"},"creationDate":{"$":"2016-07-09"},"formatsAvailable":{"format":[{"$":"dkabm"},{"$":"marcxchange"}]}}]},"formattedCollection":{"briefDisplay":{"manifestation":[{"accessType":{"$":"physical"},"creator":{"$":"Erlend Loe"},"fedoraPid":{"$":"870970-basis:26717159"},"identifier":{"$":"870970-basis:26717159"},"language":{"$":"Dansk"},"title":{"$":"Kvinden flytter ind"},"titleFull":{"$":"Kvinden flytter ind"},"type":{"$":"Bog"},"workType":{"$":"book"}}]}}}],"facetResult":{"$":""},"statInfo":{"fedoraRecordsCached":{"$":"0"},"fedoraRecordsRead":{"$":"2"},"time":{"$":"0.1"},"trackingId":{"$":"os:2017-12-24..."}}}},"@namespaces":{"ac":"http:\\/\\/biblstandard.dk\\/ac\\/namespace\\/","dbcaddi":"http:\\/\\/oss.dbc.dk\\/rdf\\/dbcaddi#","dbcbib":"http:\\/\\/oss.dbc.dk\\/rdf\\/dbcbib#","dc":"http:\\/\\/purl.org\\/dc\\/elements\\/1.1\\/","dcmitype":"http:\\/\\/purl.org\\/dc\\/dcmitype\\/","dcterms":"http:\\/\\/purl.org\\/dc\\/terms\\/","dkabm":"http:\\/\\/biblstandard.dk\\/abm\\/namespace\\/dkabm\\/","dkdcplus":"http:\\/\\/biblstandard.dk\\/abm\\/namespace\\/dkdcplus\\/","docbook":"http:\\/\\/docbook.org\\/ns\\/docbook","kml":"http:\\/\\/www.opengis.net\\/kml\\/2.2","marcx":"info:lc\\/xmlns\\/marcxchange-v1","mx":"http:\\/\\/www.loc.gov\\/MARC21\\/slim","of":"http:\\/\\/oss.dbc.dk\\/ns\\/openformat","ofo":"http:\\/\\/oss.dbc.dk\\/ns\\/openformatoutput","os":"http:\\/\\/oss.dbc.dk\\/ns\\/opensearch","oso":"http:\\/\\/oss.dbc.dk\\/ns\\/opensearchobjects","oss":"http:\\/\\/oss.dbc.dk\\/ns\\/osstypes","xs":"http:\\/\\/www.w3.org\\/2001\\/XMLSchema","xsi":"http:\\/\\/www.w3.org\\/2001\\/XMLSchema-instance"}}'
};
...
describe('Automated test: work_multiple_pid_shelf.auto', () => {
  it('has same result as recorded (in work_multiple_pid_shelf.auto)', () => {
    assert(
