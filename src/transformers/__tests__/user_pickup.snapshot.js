...
describe('Automated test: user-pickup', () => {
  it('expected response. ID:0f3sbr, for {"pretty":true}', done => {
    ...
    provider
      .execute('user', {pretty: true}, context)
      .then(result => {
