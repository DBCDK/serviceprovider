...
// Request: suggest {"q":"fisk","type":"subject","limit":3}
'use strict';
import Provider from '../../provider/Provider.js';
import {assert, fail} from 'chai';

let provider = Provider();
let mockData = {"[\"suggestsubject\",{\"qs\":{\"query\":\"fisk\",\"rs\":3,\"n\":3}}]":"{\"responseHeader\": {\"svn-revision\": \"97895\", \"ab-id\": \"1\", \"rt_searches\": [\"fisk\", \"fiske\", \"fisker\"], \"args\": {\"hr\": \"None\", \"hl\": \"None\", \"rs\": \"3\"}, \"q\": \"fisk\", \"version\": \"0.1.0\", \"build\": \"263\", \"time\": 8}, \"response\": {\"suggestions\": [{\"frequency\": 536096, \"suggestion\": \"biografiske\"}, {\"frequency\": 66537, \"suggestion\": \"fisk\"}, {\"frequency\": 54422, \"suggestion\": \"fiskeri\"}], \"numFound\": 119}}"};

describe('Automated test: suggest-subject', () => {
  it('expected response. ID:px6vy3, for {"q":"fisk","type":"subject","limit":3}', (done) => {
    ...
    provider.execute('suggest', {"q":"fisk","type":"subject","limit":3}, context)
      .then(result => {
        assert.deepEqual(result,
            {"statusCode":200,"data":[{"term":"biografiske"},{"term":"fisk"},{"term":"fiskeri"}]});
        done();
      })
      .catch(result => {
        fail({throw: result}, {"statusCode":200,"data":[{"term":"biografiske"},{"term":"fisk"},{"term":"fiskeri"}]});
        done();
      });
  });
});
