...
// Request: renew {"pretty":true,"loanId":"NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw="}
'use strict';
...
describe('Automated test of the renew endpoint', () => {
  it('expected response. ID:g118lt, for {"pretty":true,"loanId":"NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw="}', (done) => {
    ...
    provider.execute('renew', {"pretty":true,"loanId":"NCIPMDAxOXwwMDAwMDMyNDg0fFJvc2VuLCBNaWNoYWVsfFNtdXR8fHw="}, context)
      .then(result => {
