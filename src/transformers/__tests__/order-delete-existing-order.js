...
// Request: order {"pretty":true,"orderId":"Hold:NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ==","delete":true}
'use strict';
import Provider from '../../provider/Provider.js';
import {assert, fail} from 'chai';

let provider = Provider();
let mockData = {"[\"userstatus\",\"<soapenv:Envelope xmlns:soapenv=\\\"http://schemas.xmlsoap.org/soap/envelope/\\\" xmlns:open=\\\"http://oss.dbc.dk/ns/openuserstatus\\\">\\n   <soapenv:Header/>\\n   <soapenv:Body>\\n      <open:cancelOrderRequest>\\n         <open:agencyId>DK-100451</open:agencyId>\\n         <open:authentication>\\n            <open:groupIdAut>XXXXX</open:groupIdAut>\\n            <open:passwordAut>XXXXX</open:passwordAut>\\n            <open:userIdAut>XXXXX</open:userIdAut>\\n         </open:authentication>\\n         <open:cancelOrder>\\n            <open:orderId>NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ==</open:orderId>\\n            <open:orderType>{params['cancelOrder.orderType']}</open:orderType>\\n         </open:cancelOrder>\\n         <open:outputType>json</open:outputType>\\n         <open:userId>XXXXX</open:userId>\\n         <open:userPincode>XXXXX</open:userPincode>\\n      </open:cancelOrderRequest>\\n   </soapenv:Body>\\n</soapenv:Envelope>\"]":"{\"cancelOrderResponse\":{\"cancelOrderStatus\":[{\"orderId\":{\"$\":\"NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ==\",\"@\":\"ous\"},\"orderCancelled\":{\"$\":\"\",\"@\":\"ous\"},\"@\":\"ous\"}],\"@\":\"ous\"},\"@namespaces\":{\"ous\":\"http:\\/\\/oss.dbc.dk\\/ns\\/openuserstatus\"}}"};

describe('Automated test of the order endpoint', () => {
  it('expected response. ID:or7mgt, for {"pretty":true,"orderId":"Hold:NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ==","delete":true}', (done) => {
    ...
    provider.execute('order', {"pretty":true,"orderId":"Hold:NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ==","delete":true}, context)
      .then(result => {
        assert.deepEqual(result,
            {"statusCode":200,"data":{"deleted":true,"orderId":"NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ=="}});
        done();
      })
      .catch(result => {
        fail({throw: result}, {"statusCode":200,"data":{"deleted":true,"orderId":"NCIPMDAxOXwxNS0wNC0yMDE1IDE1OjUzOjE4fHxLb21wdXRlciBmb3IgYWxsZXx8MjAxNSwgMDJ8MQ=="}});
        done();
      });
  });
});
