...
// Request: suggest {"q":"rowling","type":"creator","limit":3}
'use strict';
import Provider from '../../provider/Provider.js';
import {assert, fail} from 'chai';

let provider = Provider();
let mockData = {"[\"suggestcreator\",{\"qs\":{\"query\":\"rowling\",\"n\":3}}]":"{\"responseHeader\": {\"q\": \"rowling\", \"version\": \"0.1.0\", \"build\": \"263\", \"time\": 0, \"ab-id\": \"1\", \"args\": {\"hr\": \"None\", \"hl\": \"None\"}, \"svn-revision\": \"97895\"}, \"response\": {\"suggestions\": [{\"frequency\": 144507, \"suggestion\": \"Joanne K. Rowling\"}, {\"frequency\": 451, \"suggestion\": \"Phelps Sarah aus\"}, {\"frequency\": 62, \"suggestion\": \"Newt Scamander\"}], \"numFound\": 8}}"};

describe('Automated test of the suggest endpoint', () => {
  it('expected response. ID:8vg0yf, for {"q":"rowling","type":"creator","limit":3}', (done) => {
    ...
    provider.execute('suggest', {"q":"rowling","type":"creator","limit":3}, context)
      .then(result => {
