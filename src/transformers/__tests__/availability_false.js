...
// Request: availability {"pid":"870970-basis:28448717"}
...
describe('Automated test: availability_false', () => {
  it('expected response. ID:km5za5, for {"pid":"870970-basis:28448717"}', done => {
    context.mockData = mockData;
    provider
      .execute('availability', {pid: '870970-basis:28448717'}, context)
      .then(result => {
