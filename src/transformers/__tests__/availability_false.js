...
// Request: availability {"pid":"870970-basis:28448717","pretty":true}
...
describe('Automated test: availability_false', () => {
  it('expected response. ID:vs0c2y, for {"pid":"870970-basis:28448717","pretty":true}', (done) => {
    context.mockData = mockData;
    provider.execute('availability', {"pid":"870970-basis:28448717","pretty":true}, context)
      .then(result => {
