...
describe('Automated test: work-single_pid-collection', () => {
  it('has same result as recorded (in work-single_pid-collection)', done => {
    assert(
