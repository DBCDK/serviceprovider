// AUTOTEST GENERATOR: {"endpoint":"suggest","params":{"q":"herlev","type":"library","limit":3,"fields":["term"]}}
//
//
// AUTOMATED UNIT TEST
// DO NOT EDIT
...
const params = {q: 'herlev', type: 'library', limit: 3, fields: ['term']};
...
describe('Automated test: suggest_library.auto', () => {
  it('has same result as recorded (in suggest_library.auto)', done => {
    assert(
