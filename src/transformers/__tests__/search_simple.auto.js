...
const expected = {
  ...
  data: [
    ...
    {
      collection: ['870970-basis:26994527'],
      collectionDetails: [
        {
          accessType: ['physical'],
          pid: ['870970-basis:26994527'],
          language: ['Dansk'],
          title: ['Nu og da i Hvide Hest'],
          titleFull: ['Nu og da i Hvide Hest'],
          type: ['Bog'],
          workType: ['book']
        }
      ],
      acIdentifier: ['26994527|870970'],
      acSource: ['Bibliotekskatalog'],
      dcTitle: ['Nu og da i Hvide Hest'],
      dcTitleFull: ['Nu og da i Hvide Hest'],
      subjectDK5: ['46.37 Hvide Hest'],
      subjectDK5Text: ['Enkelte lokaliteter'],
      audience: ['voksenmaterialer'],
      publisher: ['Hvide Hest'],
      contributor: ['Anne Mousten', 'Hvide Hest forening'],
      date: ['2007'],
      typeBibDKType: ['Bog'],
      format: ['illustreret (nogle i farver)'],
      extent: ['64 sider'],
      languageISO6392: ['dan'],
      dcLanguage: ['Dansk'],
      accessType: ['physical'],
...
describe('Automated test: search_simple', () => {
  it('has same result as recorded (in search_simple)', done => {
    assert(
