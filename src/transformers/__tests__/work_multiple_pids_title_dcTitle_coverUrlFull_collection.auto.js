...
describe('Automated test: work_multiple_pids_title_dcTitle_coverUrlFull_collection.auto', () => {
  it('has same result as recorded (in work_multiple_pids_title_dcTitle_coverUrlFull_collection.auto)', done => {
    assert(
