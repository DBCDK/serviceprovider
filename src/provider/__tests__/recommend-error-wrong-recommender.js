...
describe('Automated test of the recommend endpoint', () => {
  it('expected response. ID:kl6396, for {"like":["870970-basis:45488713","870970-basis:28643713","870970-basis:29494940","870970-basis:29386404","870970-basis:28429576"],"recommender":"WAT??","limit":10,"timings":true}', (done) => {
    ...
    provider.execute('recommend', {"like":["870970-basis:45488713","870970-basis:28643713","870970-basis:29494940","870970-basis:29386404","870970-basis:28429576"],"recommender":"WAT??","limit":10,"timings":true}, context)
      .then(result => {
        assert.deepEqual(result,
            {"statusCode":400,"error":"unknown or unsupported recommender type"});
        done();
      });
  });
});
