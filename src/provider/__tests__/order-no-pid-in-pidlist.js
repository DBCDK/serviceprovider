...
describe('Automated test of the order endpoint', () => {
  it('expected response. ID:hccwxk, for {"pretty":true,"pids":[],"expires":"2016-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL","name":"NAME"}', (done) => {
    ...
    provider.execute('order', {"pretty":true,"pids":[],"expires":"2016-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL","name":"NAME"}, context)
      .then(result => {
