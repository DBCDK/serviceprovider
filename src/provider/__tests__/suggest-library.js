...
describe('Automated test of the suggest endpoint', () => {
  it('expected response. ID:zu645h, for {"q":"herlev","type":"library","limit":2}', (done) => {
    ...
    provider.execute('suggest', {"q":"herlev","type":"library","limit":2}, context)
      .then(result => {
