...
describe('Automated test of the recommend endpoint', () => {
  it('expected response. ID:jrgf7m, for {"recommender":"popular","limit":3}', (done) => {
    ...
    provider.execute('recommend', {"recommender":"popular","limit":3}, context)
      ...
      .catch(result => {
        fail({throw: result}, {"statusCode":200,"data":[{"creator":"Jussi Adler-Olsen","val":30889,"title":"Journal 64 : krimithriller","pid":"870970-basis:28511663"},{"creator":"Jussi Adler-Olsen","val":28783,"title":"Marco effekten : krimithriller","pid":"870970-basis:29754519"},{"creator":"Sara Blædel","val":26278,"title":"De glemte piger : krimi","pid":"870970-basis:29060835"}]});
        done();
      });
  });
});
