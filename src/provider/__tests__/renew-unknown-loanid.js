...
describe('Automated test of the renew endpoint', () => {
  it('expected response. ID:3ps2bg, for {"pretty":true,"loanId":"unknown"}', (done) => {
    ...
    provider.execute('renew', {"pretty":true,"loanId":"unknown"}, context)
      .then(result => {
