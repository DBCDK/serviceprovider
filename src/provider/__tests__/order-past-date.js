...
describe('Automated test of the order endpoint', () => {
  it('expected response. ID:tgf3yl, for {"pretty":true,"pids":["870970-basis:28126727"],"expires":"2000-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL","name":"NAME"}', (done) => {
    ...
    provider.execute('order', {"pretty":true,"pids":["870970-basis:28126727"],"expires":"2000-08-01","library":"DK-100451","phone":"123454","address":"ADDRESS","email":"EMAIL","name":"NAME"}, context)
      .then(result => {
